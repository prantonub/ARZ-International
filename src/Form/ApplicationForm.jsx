...
const Input = (props) => (
    <input
        {...props}
        className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 placeholder-slate-300 focus:outline-none focus:border-[#0f2044] focus:ring-2 focus:ring-[#0f2044]/10 transition-all"
    />
);
...
const Select = ({ children, ...props }) => (
    <div className="relative">
        <select
            {...props}
            className="w-full h-11 px-4 pr-10 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 appearance-none focus:outline-none focus:border-[#0f2044] focus:ring-2 focus:ring-[#0f2044]/10 transition-all cursor-pointer"
        >
            {children}
        </select>
                ...
                {steps.map((s, i) => {
                    ...
                    return (
                        <div key={n} className="flex items-center flex-1 last:flex-none">
                            <div
                                className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold shrink-0 transition-all duration-300 ${done
                            ...
                            {i < steps.length - 1 && (
                                <div
                                    className={`flex-1 h-0.5 mx-1 rounded-full transition-all duration-500 ${done ? "bg-teal-400" : "bg-slate-200"
                                        }`}
                                />
                            )}
                        </div>
    ...
    <div className="flex justify-between items-center mt-8 pt-6 border-t border-slate-100">
        ...
        {step < 4 ? (
            <button
                ...
                style={{ background: "linear-gradient(135deg, #e8294a 0%, #c0182e 100%)" }}
            >
    ...
    <div className="space-y-4">
        ...
        <Row>
            <div>
                ...
                <Input placeholder="As written in passport" value={data.fullName} onChange={e => onChange("fullName", e.target.value)} />
            </div>
            <div>
        ...
        <Row>
            ...
            <div>
                ...
                <Input placeholder="+880 13********" value={data.phone} onChange={e => onChange("phone", e.target.value)} />
            </div>
        </Row>
        <Row>
            <div>
            ...
            <div>
                ...
                <Input placeholder="e.g. Dhaka, Sylhet" value={data.city} onChange={e => onChange("city", e.target.value)} />
            </div>
        </Row>
...
const Step2 = ({ data, onChange }) => (
    <div className="">
        ...
        <div>
            ...
            <Select value={data.studyStatus} onChange={e => onChange("studyStatus", e.target.value)}>
        ...
        <SubCard icon="🎓" title="SSC Information">
            <Row>
                <div>
                    ...
                    <Input placeholder="e.g. 2022" value={data.sscYear} onChange={e => onChange("sscYear", e.target.value)} />
                </div>
                <div>
                    <Label>SSC GPA</Label>
                    <Input placeholder="e.g. 5.00" value={data.sscGpa} onChange={e => onChange("sscGpa", e.target.value)} />
                </div>
            </Row>
            <Row>
                <div>
                    <Label>SSC Group</Label>
                    <Select value={data.sscGroup} onChange={e => onChange("sscGroup", e.target.value)}>
                ...
                <div>
                    ...
                    <Input placeholder="School name" value={data.sscSchool} onChange={e => onChange("sscSchool", e.target.value)} />
                </div>
            </Row>
        </SubCard>
        ...
        <SubCard icon="🎓" title="HSC Information">
            <Row>
                <div>
                    ...
                    <Input placeholder="e.g. 2024 or Expected 2025" value={data.hscYear} onChange={e => onChange("hscYear", e.target.value)} />
                </div>
                <div>
                    <Label>HSC GPA</Label>
                    <Input placeholder="e.g. 5.00 or Awaited" value={data.hscGpa} onChange={e => onChange("hscGpa", e.target.value)} />
                </div>
            </Row>
            <Row>
                <div>
                    <Label>HSC Group</Label>
                    <Select value={data.hscGroup} onChange={e => onChange("hscGroup", e.target.value)}>
                        <option value="">Select group</option>
                        <option>Science</option>
                        <option>Commerce</option>
                        <option>Arts</option>
                ...
                <div>
                    ...
                    <Input placeholder="College name" value={data.hscCollege} onChange={e => onChange("hscCollege", e.target.value)} />
                </div>
            </Row>
        </SubCard>
        ...
        <SubCard icon="🏛️" title="University (if applicable)">
            <Row>
                <div>
                    ...
                    <Input placeholder="University name (if enrolled)" value={data.uniName} onChange={e => onChange("uniName", e.target.value)} />
                </div>
                <div>
                    <Label>Subject / Department</Label>
                    <Input placeholder="e.g. Computer Science" value={data.uniSubject} onChange={e => onChange("uniSubject", e.target.value)} />
                </div>
            </Row>
            <Row>
                <div>
                    <Label>Degree</Label>
                    <Input placeholder="e.g. BSc, BBA, MBA" value={data.degree} onChange={e => onChange("degree", e.target.value)} />
                </div>
                <div>
                    <Label>CGPA / Result</Label>
                    <Input placeholder="e.g. 3.50 / 4.00" value={data.cgpa} onChange={e => onChange("cgpa", e.target.value)} />
                </div>
            </Row>
        </SubCard>
    </div>
    ...
    <div className="space-y-4">
        ...
        <Row>
            <div>
                ...
                <Select value={data.intake} onChange={e => onChange("intake", e.target.value)}>
            ...
            <div>
                ...
                <Input placeholder="e.g. Engineering, Business, IT" value={data.field} onChange={e => onChange("field", e.target.value)} />
            </div>
        </Row>
        ...
        <Row>
            <div>
                ...
                <Select value={data.koreanLevel} onChange={e => onChange("koreanLevel", e.target.value)}>
            ...
            <div>
                ...
                <Input placeholder="e.g. IELTS 5.5 or N/A" value={data.englishScore} onChange={e => onChange("englishScore", e.target.value)} />
            </div>
        </Row>
    </div>
);
    ...
    <div className="space-y-5">
        ...
        <Row>
            <div>
                ...
                <Select value={data.passport} onChange={e => onChange("passport", e.target.value)}>
        ...
        <Row>
            <div>
                ...
                <Select value={data.appliedKorea} onChange={e => onChange("appliedKorea", e.target.value)}>
                    <option value="">Select</option>
            ...
            <div>
                ...
                <Select value={data.visaRejection} onChange={e => onChange("visaRejection", e.target.value)}>
                    <option value="">Select</option>
                    <option>No</option>
        ...
        <SubCard icon="💰" title="Financial Information">
            <Row>
                <div>
                    ...
                    <Select value={data.sponsor} onChange={e => onChange("sponsor", e.target.value)}>
                ...
                <div>
                    ...
                    <Input placeholder="e.g. Business, Government Job" value={data.sponsorOccupation} onChange={e => onChange("sponsorOccupation", e.target.value)} />
                </div>
            </Row>
            <div>
        ...
        <div>
            <Label required>How did you hear about Hangeul?</Label>
        ...
        <div className="flex gap-3 p-4 rounded-xl bg-blue-50 border border-blue-100">
            ...
            <p className="text-xs text-blue-600 leading-relaxed">
                By submitting this form you confirm that the information provided is accurate. Our counselor will contact you within 24 hours to schedule your free session. All information is kept strictly confidential.
            </p>
        </div>
    </div>
);
    ...
    <div className="text-center py-12 px-6">
        <div className="w-20 h-20 rounded-full bg-teal-50 flex items-center justify-center mx-auto mb-5">
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                ...
                <path d="M10 18l5.5 5.5L26 12" stroke="#0d9488" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </div>
        <h2 className="text-2xl font-bold text-[#0f2044] mb-2">Application Submitted!</h2>
        <p className="text-slate-500 text-sm max-w-sm mx-auto leading-relaxed">
            Thank you! Our counselor will contact you within 24 hours to schedule your free consultation session.
        </p>
        <button
...
export default function ApplicationForm() {
    ...
    const [form, setForm] = useState({
        ...
        city: "",
        // Step 2
        studyStatus: "", sscYear: "", sscGpa: "", sscGroup: "", sscSchool: "",
        hscYear: "", hscGpa: "", hscGroup: "", hscCollege: "",
        uniName: "", uniSubject: "", degree: "", cgpa: "",
        // Step 3
        program: "", intake: "", field: "", koreanLevel: "", englishScore: "",
        // Step 4
        passport: "", passportExpiry: "", appliedKorea: "", visaRejection: "",
        sponsor: "", sponsorOccupation: "", budget: "", referral: "", notes: "",
    });
    ...
    const submit = async () => {
        if (!form.fullName || !form.phone || !form.email) {
            setSubmitError("Please complete your name, phone and email before submitting.");
            setStep(1);
            return;
        }
        setSubmitting(true);
    ...
    const stepComponents = [
        <Step1 data={form} onChange={update} />,
        <Step2 data={form} onChange={update} />,
        <Step3 data={form} onChange={update} />,
        <Step4 data={form} onChange={update} />,
    ];
    ...
    return (
        <div className="min-h-screen bg-slate-100 py-10 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                {/* Header */}
                {!submitted && (
                    <Header title={"Form"} subTitle={"Student Application &"} subTitle2={"Pre-Consultation Form"} text={"Please fill this form completely before your counseling session. This helps us give you the most accurate guidance."}></Header>
                )}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 px-6 py-7 sm:px-8">
                    {submitted ? (
                        ...
                        <>
                            ...
                            {submitError && (
                                <p className="mt-4 text-sm font-semibold text-rose-600">{submitError}</p>
                            )}
                            <NavButtons step={step} onBack={back} onNext={next} onSubmit={submit} submitting={submitting} />
                        </>
                    )}
                </div>
            </div>
